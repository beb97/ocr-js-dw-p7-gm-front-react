  ...
  return (
    <form>
        <fieldset>
            ...
            <p>{inputMessage}</p>
            <div class="field">
                <label for="titre" class="">Titre:
                </label>
                <input type="text" class="" id="titre" placeholder="votre titre" name="titre"
                value={inputTitre}
            ...
            <div class="field">
                ...
                <textarea rows="5" cols="1" class="" id="message" placeholder="votre message" name="message"
                value={inputMessage} 
